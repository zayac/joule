...
#define read_DOWN_send_color_ochannels {1 COMMA "denoise_color"}
#define read_DOWN_send_grayscale_ochannels {1 COMMA "denoise_grayscale"}
...
#define read_DOWN__1_read_color_1_read_unchanged_send_color_decl  COMMA int K
#define read_DOWN__1_read_color_1_read_unchanged_send_color_use  COMMA K
#define read_DOWN__1_read_grayscale_decl 
#define read_DOWN__1_read_grayscale_use 
#define read_DOWN__1_read_grayscale_tuple_get 
#define read_DOWN__1_read_grayscale_types 
#define read_DOWN__1_read_grayscale_send_grayscale_decl 
#define read_DOWN__1_read_grayscale_send_grayscale_use 
