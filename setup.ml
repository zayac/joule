...
(* OASIS_START *)
(* DO NOT EDIT (digest: c66136f3e120827aa6735950eca5b7e2) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/zayac/ocaml-picosat";
          synopsis = "Constraint Aggregation Layer";
          description = Some "Constraint Aggregation Layer";
          categories = [];
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "\025\012]ùgB\006¦²¶·Þ\n\002\000¡";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
