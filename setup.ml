...
(* OASIS_START *)
(* DO NOT EDIT (digest: 207c599553cceab96a1e78da461434d5) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          synopsis =
            "Constraint solver for Data Description Language in AstraKahn language";
          description =
            Some
              [
                 OASISText.Para
                   "Joule is a solver for constraints formulated in Data Description Language. It is used in the Constraint Aggregation Layer for AstraKahn language."
              ];
          categories = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\159\025ZÃ\021GK‹Ë‚OH∏\1311¡";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
