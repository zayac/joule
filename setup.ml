...
(* OASIS_START *)
(* DO NOT EDIT (digest: eb27389ac1b71bb237118b8f9f0707f4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          synopsis =
            "Tool for components' interfaces coordination in stream processing language";
          description =
            Some
              [
                 OASISText.Para
                   "Given a set of constraints that represent producer-consumer relations for message types in channels of a stream processing network, Joule verifies the consistency of the constraints.  Moreover, it finds values for undefined (generic) types in the network that do not cause violation of constraints."
              ];
          categories = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "¼IÏm\147\154Ñ\151ÿÅE,\002\152R\136";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
