...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9958cc399d1543458370e8bf1f0dd64c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          synopsis = "code generation";
          description = Some [OASISText.Para "code generation"];
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "ô}¢#\137nÚ\149\142c¥\022Rïé0";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
