...
(* OASIS_START *)
(* DO NOT EDIT (digest: f5c232ef0765e34786443bd55c2065f3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/zayac/joule";
          synopsis =
            "Tool for interface coordination in a programming language based on Kahn Process Networks";
          description =
            Some
              [
                 OASISText.Para
                   "Given a set of constraints that represents producer-consumer relations for messages in KPN channels, Joule verifies the consistency of the constraints and finds specific instances for all type variables if such exist."
              ];
          categories = [];
          ...
          clean_custom =
            {
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("rm", ["-f"; "tests/*.my"; "tests/*.myerr"])))
                 ]
            };
          distclean_custom =
            {
          ...
          sections =
            [
               Flag
                 ({
                     cs_name = "static_picosat";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description =
                        Some "Link PicoSAT as a static library";
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Link Foreign Function Interface (FFI) as a static library";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Executable
                 ({
                      ...
                      bs_cclib =
                        [
                           ...
                           (OASISExpr.EAnd
                             ...
                             ["-force_load /usr/local/lib/libpicosat.a"]);
                           (OASISExpr.EAnd
                              (OASISExpr.ENot
                                 (OASISExpr.ETest ("system", "linux")),
                                OASISExpr.ENot
                   ...
                   {exec_custom = false; exec_main_is = "joule.ml"});
               Executable
                 ({
                     cs_name = "debug_solver";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "debug_solver.ml"});
               Doc
                 ({
                     cs_name = "api-joule";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/joule";
                      doc_title =
                        "Documentation and API reference for Joule solver";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "ì×Ô\149$l\130\151¬_»7\152\017©=";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
